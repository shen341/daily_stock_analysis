    ...
    def __init__(
        ...
        try:
            self.search_service = SearchService(
                ...
                bing_news_search_enabled=getattr(self.config, "bing_news_search_enabled", True),
                google_news_search_enabled=getattr(self.config, "google_news_search_enabled", True),
