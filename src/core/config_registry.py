...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "BING_NEWS_SEARCH_ENABLED": {
        ...
        "description": "Enable free Bing News RSS search (zero API key, accessible in mainland China). Default: true.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "GOOGLE_NEWS_SEARCH_ENABLED": {
        ...
        "description": "Enable free Google News RSS search (zero API key, supports overseas/proxy environments). Default: true.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
...
_FIELD_HELP_METADATA: Dict[str, Dict[str, Any]] = {
    ...
    "BING_NEWS_SEARCH_ENABLED": {
        "help_key": "settings.data_source.free_news_search",
        "examples": [
